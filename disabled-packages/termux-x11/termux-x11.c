...
# define TERMUX_PREFIX "/data/data/com.icst.terminal/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/com.icst.terminal.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "com.icst.terminal.x11/.MainActivity", NULL};
